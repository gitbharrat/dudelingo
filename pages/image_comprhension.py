        ...
        messages=[
            {
                ...
                "content": [
                    {
                        "type": "text",
                        "text": "Describe this image like an IELTS exam."
                    },
                    {
                        "type": "image_url",
                        "image_url": {
...
def compare_descriptions(model_desc, user_desc):
    ...
    def app():
        ...
        st.write("Learn to understnad and describe image in your target language. Thhis task focuses on improving your speaking skills and vocabulary.")
        ...
        if st.session_state.image_shown:
            ...
            if st.session_state.image_generated == False:
                ...
                st.session_stat.image_url = image_url
                st.session_state.image_generated = True
                print(st.session_stat.image_generated)
